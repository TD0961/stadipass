        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <Link to="/" className="flex items-center space-x-2 mb-4">
              ...
              <span className="text-xl font-bold">StadiPass</span>
            </Link>
            <p className="text-neutral-400 mb-4 max-w-md">
              Your premier destination for stadium tickets. Experience the thrill of live events with secure, 
              convenient ticket purchasing and seamless entry validation.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/tickets" className="text-neutral-400 hover:text-white transition-colors">
                  My Tickets
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-center space-x-2">
                ...
                <span className="text-neutral-400">support@stadipass.com</span>
              </li>
              <li className="flex items-center space-x-2">
        ...
        <div className="border-t border-neutral-800 mt-8 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-neutral-400 text-sm">
              © 2024 StadiPass. All rights reserved.
            </p>
