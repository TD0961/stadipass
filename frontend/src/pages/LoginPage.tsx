...
export const LoginPage = () => {
  ...
  const { values, errors, isSubmitting, handleChange, handleBlur, handleSubmit } = useForm<LoginFormData>({
    initialValues: {
      email: '',
      password: '',
      rememberMe: false,
    ...
    <div className="min-h-screen flex items-center justify-center bg-neutral-50 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full space-y-8">
        <div className="text-center">
          ...
          <p className="text-body mt-2">Sign in to your StadiPass account</p>
        </div>
